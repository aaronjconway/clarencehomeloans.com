...
export const reviews: Review[] = [
    ...
    {
        author: "Paul Huang",
        content: "I had the pleasure of working with Austin, and I cannot recommend him highly enough. As a mortgage broker, he has been incredibly helpful in educating me on the various options available, ensuring I understand what would be most suitable for my needs. What sets Austin apart is his genuine approach — he always takes the time to listen carefully to my situation and offers solutions tailored to help me. There was never any pressure to make a decision or buy anything; his focus was purely on helping me make the best choice for my circumstances. If you’re looking for a knowledgeable, patient, and trustworthy mortgage broker, Austin should be at the top of your list.",
    },
    {
        author: "Shawn Proano",
    ...
    {
        author: "Lindsey Tran",
        content: "Austin is a true professional who genuinely cares about his clients. As a single mom navigating a complex buying process, I appreciated how kind, responsive, and thorough he was every step of the way. He never made me feel like just another file — he was fully engaged and kept me informed with clarity and transparency. Thanks to Austin, I closed on a beautiful home that fits my budget and my life. He made it feel possible when I doubted it was.",
    },
    {
        author: "Jorge D.",
        content: "From our very first conversation, Austin made me feel seen, heard, and supported. He broke everything down in simple terms and was extremely patient with all of my questions — and there were a lot! What really stood out was how he tailored everything to fit my unique situation and even helped me qualify for programs I didn’t know existed. If you’re looking for someone who truly wants what’s best for you, Austin is your guy.",
    },
    {
        author: "Nicole & Adam Wills",
        content: "Working with Austin felt like having a financial coach, advocate, and friend all in one. He treated our goals like they were his own and didn’t stop until he found the right solution for us. We were blown away by how accessible and proactive he was, even on weekends. Our closing went smoother than we ever imagined, and that’s 100% thanks to Austin’s guidance and hustle.",
    },
    {
        author: "Victor Mendez",
        content: "Austin is a rockstar in the mortgage world. I’ve worked with other brokers in the past, and no one comes close to his level of dedication and professionalism. He’s sharp, honest, and puts in the extra work without being asked. I felt confident every step of the way and ended up with a loan that exceeded my expectations. I recommend him to everyone I know.",
    },
    {
        author: "Bridget O’Leary",
        content: "What an absolute gift it was to work with Austin. Buying my first home was a big emotional step for me, and I was overwhelmed at the start. Austin stepped in like a steady hand — always calm, never pushy, and endlessly encouraging. He helped me get a great rate, connected me with a great agent, and made me feel empowered through it all. I’ll never forget how he made this milestone feel joyful, not stressful.",
    },
];
